  ...
  <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
    <el-tab-pane label="潜在学员" name="first">
      ...
      <el-table :data="potentialStudent" style="width: 100%">
        ...
        <el-table-column prop="birthday" label="生日" width="600" />
        ...
        <el-table-column prop="最后一次跟进" label="Last_follow" width="120" />
        <el-table-column prop="下—次跟进" label="Next_follow" width="120" />
        <el-table-column prop="备注" label="note" width="120" />
        <el-table-column prop="添加日期" label="Add_date" width="120" />
...
const potentialStudent = [
  {
    ...
    phone: "Tom",
    age: "California",
    birthday: "Los Angeles",
    To_follow: "No. 189, Grove St, Los Angeles",
    Follow_person: "CA 90036",
    intention: "",
    source: "Home",
    Last_follow: "Home",
    Next_follow: "Home",
