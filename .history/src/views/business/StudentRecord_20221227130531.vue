...
const queryEmployee = async () => {
  const res = await getEmployeeData();
  console.log(res);
  Employee_Information = res.employeeNme;
  Employee_Information = res.phone;
  Employee_Information = res.Whether_to_teachs;
  Employee_Information = res.role;
  Employee_Information = res.note;
};
