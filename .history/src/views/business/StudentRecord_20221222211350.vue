        ...
        >
          <el-form :model="Potential_trainees" label="基本信息">
            ...
            <el-form-item>
              ...
              <el-icon><CameraFilled title="在线拍照" /></el-icon
...
const drawImage = () => {
  ...
  thisContext.value = thisCancas.value.getContext("2d");
  thisVideo.value = document.getElementById("videoCamera");
  thisContext.value.drawImage(thisVideo, 0, 0, 300, 200);
  //获取图片地址
...
————————————————
版权声明：本文为CSDN博主「川上裤子」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/weixin_62458342/article/details/124178277
