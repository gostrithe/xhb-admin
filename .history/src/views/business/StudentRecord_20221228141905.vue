...
const savePotentialTrainees = async () => {
  console.log(AddPotential_trainees.tag);
  AddPotential_trainees.tag = (AddPotential_trainees.tag as unknown as string[]).join("|")
  const res = await postStudents({ ...AddPotential_trainees });
