...
const queryEmployee = async () => {
  ...
  console.log(res);
  Object.assign(Employee_Information.value[0], res.employeeNme);
  Employee_Information.value[0] = res.employeeNme;
  Employee_Information.value[1] = res.phone;
  Employee_Information.value[2] = res.Whether_to_teachs;
  Employee_Information.value[3] = res.role;
  Employee_Information.value[4] = res.note;
};
