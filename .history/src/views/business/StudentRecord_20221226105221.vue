    ...
    <el-tab-pane label="潜在学员" name="first">
      ...
      <el-form>
        ...
        <el-drawer
          ...
          size="30%"
        >
          <el-form :model="studentTypr" label="基本信息" label-position="right">
      ...
      >
        ...
        <el-table-column
          prop="Available_credits"
          label="可用积分"
          width="120"
        />
        <el-table-column prop="source" label="来源" width="120" />
        <el-table-column prop="follow_people" label="跟进人" width="120" />
        <el-table-column prop="GZ_A" label="学管师" width="120" />
      </el-table>
    </el-tab-pane>
