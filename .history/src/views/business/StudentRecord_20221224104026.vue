    ...
    <el-tab-pane label="潜在学员" name="first">
      ...
      <el-form>
        ...
        <el-drawer
          ...
          size="30%"
        >
          <el-form :model="Potential_trainees" label="基本信息">
            ...
            <el-form-item label="学员姓名">
              <el-input placeholder="请输入学员姓名" v-model="Potential_trainees.studentName" />
            </el-form-item>
            <el-form-item label="手机号码">
              <el-input placeholder="请输入手机号码" v-model="Potential_trainees.studentPhone" />
            </el-form-item>
            ...
            <el-form-item label="就读学校">
              <el-input v-model="Potential_trainees.school" placeholder="目前就读学校的名称" />
            </el-form-item>
            <el-form-item label="就读年纪">
              <el-select
