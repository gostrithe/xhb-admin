    ...
    <el-form-item label="跟进人">
      ...
      <el-dialog v-model="dialogTableVisible" title="请选择跟进人">
        <el-table :data="Employee_Information">
          <el-table-column property="Staff_nameMobile" label="员工名称" width="150" />
          <el-table-column property="name" label="手机号码" width="200" />
          <el-table-column property="address" label="是否授课" />
          <el-table-column property="address" label="角色" />
...
const Employee_Information = [
  {
    Staff_nameMobile: "芭莎",
    员工名称Staff nameMobile
手机号码phone number
ation
是否授课Whether to teach
角色role
备注note
: "15900824880",
    address: "是",
