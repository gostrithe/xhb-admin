...
const queryEmployee = async () => {
  ...
  Employee_Information.value = res.employeeNme;
  Employee_Information.value = res.phone;
  Employee_Information.value = res.Whether_to_teachs;
  Employee_Information.value = res.role;
  Employee_Information.value = res.note;
  console.log(Employee_Information.value.employeeNme);
};
