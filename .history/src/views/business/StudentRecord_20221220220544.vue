<template>
  <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
    <el-tab-pane label="潜在学员" name="first">
      ...
      <el-form>
        <el-button class=>添加潜在学员</el-button>
        <el-button class=>今日待跟进</el-button>
        <el-button class=>分配跟进人</el-button>
        <el-button class=>添加跟进记录</el-button>
        <el-button class=>更多操作</el-button>
      </el-form>
