...
const queryEmployee = async () => {
  const res = await getEmployeeData();
  Employee_Information.value = res!.data;
  Employee_Information.value.filter((item) => {
    return item =Potential_trainees.info
  });
  Potential_trainees.info;
  console.log("Employee_Information.value", Employee_Information.value);
};
