<template>
  <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
    <el-tab-pane label="潜在学员" name="first">
      ...
      <el-form>
        <el-button class="el-button--mini" type="primary"
          ><el-icon><EditPen /></el-icon
          ><el-drawer title="添加潜在学员" direction="rtl" size="50%"class="el-button--mini" type="primary"
            ><el-form></el-form></el-drawer
          >添加潜在学员</el-button
        >
...
import { Grid, EditPen, ArrowDown } from "@element-plus/icons-vue";
