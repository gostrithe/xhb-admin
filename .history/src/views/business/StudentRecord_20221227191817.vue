    ...
    <el-tab-pane label="潜在学员" name="first">
      ...
      >
        ...
        <el-form-item label="跟进人">
          ...
          >
            ...
            <el-pagination
              ...
              class="pagination"
              small
              @prev-click="prevPagechang"
              @next-click="nextPagechang"
        ...
        <el-form-item>
          ...
          <el-button type="primary" @click="queryPotentialTrainees" class="btn"
            >查询</el-button
          >
          <el-button
      ...
      <el-form>
        ...
        >
          ...
          >
            ...
            <el-form-item label="备用号码"></el-form-item>
            <el-form-item label="家庭住址"></el-form-item>
            <el-form-item label="意向级别"></el-form-item>
            <el-form-item label="跟进状态"></el-form-item>
            <el-form-item label="跟进人"></el-form-item>
            <el-form-item label="b'biao'qian"></el-form-item>
...
const prevPagechang = (res: number) => {
  console.log(res);
};

const nextPagechang = (res: number) => {
  console.log("res", res);
};

const pagesizes = async () => {};

const queryPotentialTrainees = () => {
  console.log("queryPotentialTrainees");
};

const queryReferrer = () => {
  console.log("queryReferrer");
};
const referrer = [
  {
    name: "drrgjd",
